...
| 3 | 🔌 **Dış API** (Partner entegrasyon) | `/api/partner/v1` + `Controllers/Partner/` | F0→F2b + **Satıcı P1 CANLIDA + P2 kargo bildirimi UYGULANDI ⚠️ restart bekliyor (2026-08-11)**: fiyat + sipariş okuma + POST shipment (CarrierName migration canlı DB'de); plan `docs/pazaryeri-satici-api-degerlendirmesi.md` | Satıcı P3a hakediş → P3b relay e-posta → P4 rate limit/sandbox → P5 panel | `docs/pazaryeri-satici-api-degerlendirmesi.md`, `docs/api-hesaplari-tasarimi.md` |

...
| 3 | 🔌 **Dış API** (Partner entegrasyon) | `/api/partner/v1` + `Controllers/Partner/` | F0→F2b + **Satıcı P1 UYGULANDI ⚠️ restart bekliyor (2026-08-11)**: fiyat güncelleme + satıcı sipariş okuma (K1-K6 kararlı plan `docs/pazaryeri-satici-api-degerlendirmesi.md`); order.read satıcı taban paketine alındı | Satıcı P2 kargo bildirimi → P3a hakediş → P3b relay e-posta → P4 rate limit/sandbox → P5 panel | `docs/pazaryeri-satici-api-degerlendirmesi.md`, `docs/api-hesaplari-tasarimi.md` |

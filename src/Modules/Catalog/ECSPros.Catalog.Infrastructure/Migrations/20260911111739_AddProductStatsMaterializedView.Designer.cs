...
namespace ECSPros.Catalog.Infrastructure.Migrations
{
    ...
    [Migration("20260911111739_AddProductStatsMaterializedView")]
    partial class AddProductStatsMaterializedView
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECSPros.Catalog.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasIndex("SupplierId", "SupplierProductCode")
                        .IsUnique()
            ...
            modelBuilder.Entity("ECSPros.Catalog.Domain.Entities.ProductStats", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("ColorsWithImage")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("mv_product_stats", "catalog", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("ECSPros.Catalog.Domain.Entities.ProductSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("product_submissions", "catalog");
                });
            ...
            modelBuilder.Entity("ECSPros.Catalog.Domain.Entities.ProductStats", b =>
                {
                    b.HasOne("ECSPros.Catalog.Domain.Entities.Product", null)
                        .WithOne("Stats")
                        .HasForeignKey("ECSPros.Catalog.Domain.Entities.ProductStats", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });

...
| B | Navigasyon + Ana Sayfa + Liste + Detay (gerçek port) | 🔶 Devam ediyor — B1 + B2 + B3 + B5 mini sepet (2026-07-09) + B6 + B7 + B8 + B9 + B10 + B14 ✅; kalan: B4 (giriş/kayıt modalları) / B11 (öne çıkar) / B12 (stok anahtarı) / B13 (görsel QA) |

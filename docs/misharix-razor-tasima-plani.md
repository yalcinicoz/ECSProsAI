...
| D | Üye oturumu (Razor tarafı) + SMS/OTP altyapısı | 🔵 Sürüyor — D1+D3 ✅ (HttpOnly cookie + SSR kimlik + logout/session iptali; kayıt belgeleri CMS + Member.Consents onay kaydı; D2 ve D6 büyük ölçüde B4+D1 ile kapandı); kalan: D4 SMS/OTP, D5 BCrypt geçişi, D7 QA |

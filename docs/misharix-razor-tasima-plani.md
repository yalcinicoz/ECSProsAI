...
| B | Navigasyon + Ana Sayfa + Liste + Detay (gerçek port) | 🔶 Devam ediyor — B1 nav + B2 arama + B3 duyuru + B6 ana sayfa + B7 ürün listesi + B8 kart derinleştirme + B9 ürün detay + B10 sunucu tarafı filtre/sıralama/kategoride-ara (2026-07-09) + B14 domain geçişi ✅; kalan: B4-B5 (giriş modalları + mini sepet) / B11 (öne çıkar) / B12 (stok anahtarı) / B13 (görsel QA) |

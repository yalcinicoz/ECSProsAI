...
| B | Navigasyon + Ana Sayfa + Liste + Detay (gerçek port) | 🔶 Devam ediyor — B1 nav + B2 arama + B7 ürün listesi + B8 kart derinleştirme + B9 ürün detay + B14 domain geçişi ✅ (2026-07-08); sırada B3 duyuru / B6 ana sayfa |
...
|---|---|---|---|---|
| Duyuru şeridi | kayan metin | G'de kişiselleştirme bloğu (K7) | B3→G8 | ⬜ |

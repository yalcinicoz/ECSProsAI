...
| C | Sepet + Checkout | 🔵 Sürüyor — C1–C7+C10 ✅ (sepet, kupon, teslimat+adres+geo, ödeme, taksit, TCKN, checkout uçtan uca); kalan: C8 sözleşmeler, C9 stok haberi, C11 QA kapanışı |

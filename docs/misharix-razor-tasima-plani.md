...
| E | Hesabım kümesi (12 sayfa + yeni backend özellikleri) | 🔵 Sürüyor — E1+E2 ✅ (çerçeve + Üyelik Bilgilerim: profil GET/PUT, Member.CityId, duyuru tercihleri jsonb, oturum IP/UA + Aktif Cihazlar/Giriş Geçmişi) |

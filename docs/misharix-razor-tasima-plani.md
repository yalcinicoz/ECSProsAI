...
| E | Hesabım kümesi (12 sayfa + yeni backend özellikleri) | 🔵 Sürüyor — E1+E2+E3 ✅ (çerçeve; Üyelik Bilgilerim: profil GET/PUT + CityId + tercihler + oturum IP/UA; Adreslerim: CRUD tam — güncelleme + varsayılan API'leri eklendi) |

...
| C | Sepet + Checkout | 🔵 Sürüyor — C1–C8+C10 ✅ (sepet, kupon, teslimat+adres+geo, ödeme, taksit, TCKN, sözleşmeler CMS+kabul kaydı, checkout uçtan uca); kalan: C9 stok haberi, C11 QA kapanışı |

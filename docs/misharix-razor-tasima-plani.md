...
| B | Navigasyon + Ana Sayfa + Liste + Detay (gerçek port) | 🔶 Devam ediyor — B1–B10 + B14 ✅ (B4+B5+B10 2026-07-09); kalan: B11 (öne çıkar) / B12 (stok anahtarı) / B13 (görsel QA — faz kapanışı) |

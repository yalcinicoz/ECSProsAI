...
|---|---|---|---|
| Kart → detay linki (`data-ms-kart-link`) | VAR | B8 | ⬜ |
| Hover görsel galerisi + nokta göstergeleri | VAR (variant images) | B8 | ⬜ |
...
| Renk rozeti + renk tooltip (diğer renk linkleri) | VAR (varyantlar) | B8 | ⬜ |
